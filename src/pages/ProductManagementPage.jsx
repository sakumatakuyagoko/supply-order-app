...
const ProductManagementPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.name || !formData.price) {
            setStatusMessage({ type: 'error', text: '商品名と価格は必須です' });
            return;
        }
        ...
        try {
            ...
            if (activeTab === 'register') {
                result = await registerProduct(formData);
            } else {
            ...
            if (result.success) {
                ...
                if (activeTab === 'register') {
                    // Reset form
                    setFormData({ id: '', name: '', category: '', price: '', unit: '個', image: '' });
    ...
    const handleSelectProductToEdit = (product) => {
        setFormData({
            ...
            price: product.price,
            unit: product.unit || '個',
            image: product.image // Keep existing URL
        });
        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <main className="container mx-auto p-4 max-w-lg">
                ...
                <div className="flex bg-white rounded-lg p-1 shadow-sm mb-6">
                    <button
                        onClick={() => { setActiveTab('register'); setFormData({ id: '', name: '', category: '', price: '', unit: '個', image: '' }); setImagePreview(null); }}
                    ...
                    <button
                        onClick={() => { setActiveTab('edit'); setFormData({ id: '', name: '', category: '', price: '', unit: '個', image: '' }); setImagePreview(null); }}
                    ...
                    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    <label className="block text-sm font-bold text-gray-600 mb-1">業者/カテゴリ</label>
                                    <input
                                        type="text"
                                        name="category"
                                        value={formData.category}
                                        onChange={handleInputChange}
                                        className="w-full border border-gray-300 rounded px-3 py-2 bg-gray-50 focus:bg-white indent-0"
                                        placeholder="例: 大塚商会"
                                    />
                                </div>
                                <div>
                            ...
                            <div className="pt-4 flex gap-3">
                                {activeTab === 'edit' && (
                                    <button
                                        type="button"
                                        onClick={() => { setFormData({ id: '', name: '', category: '', price: '', unit: '個', image: '' }); setImagePreview(null); }}
