                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex-1 flex flex-col gap-2">
                                        <div className="flex gap-2">
                                            {/* File Select Button */}
                                            <label className="flex-1 bg-gray-100 text-gray-700 py-2 rounded-lg text-center text-sm font-bold cursor-pointer hover:bg-gray-200 border border-gray-300">
                                                <span>ファイル選択</span>
                                                <input
                                                    type="file"
                                                    accept="image/*"
                                            ...
                                            {/* Camera Button */}
                                            <label className="flex-1 bg-blue-50 text-blue-700 py-2 rounded-lg text-center text-sm font-bold cursor-pointer hover:bg-blue-100 border border-blue-200 flex items-center justify-center gap-1">
                                        ...
                                        <p className="text-xs text-gray-400">※5MB以下の画像 (jpg, png)</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-gray-600 mb-1">単位 (数値/文字)</label>
                                        <input
                                            type="text"
                                            name="unit"
                                            value={formData.unit}
